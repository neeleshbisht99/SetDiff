...
CLS_0_DIFF = """
    ...
    Out of all these captions, select top 10 that are more likely to be true for Group A compared to Group B. Please write the list of captions (separated by bullet points "*"). For example:
    * "a dog next to a horse"
    * "a car in the rain"
    * "low quality"
    * "cars from a side view"
    ...
    * INCORRECT: "Insects (cockroach, dragonfly, grasshopper)" CORRECTED: "insects"
    ...
    Again, I want to figure out what kind of distribution shift are there. List captions that hold more often for the images (not properties) in group A compared to group B. Answer with a list (separated by bullet points "*"). Your response:
"""